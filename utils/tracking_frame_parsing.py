...
# 출력 이미지 저장 경로
output_directory = '/Users/seowoohan/Desktop/Developments/DVA_LAB/DVA_LAB/output/Datasets/Tracking/RAW/'
    ...
    for filename in files:
        if any(filename.endswith(ext) for ext in video_extensions):
            ...
            while True:
                ...
                output_filename = os.path.join(output_directory, output_subfolder, f'{filename_without_extension}_frame_{frame_number:05d}.PNG')
