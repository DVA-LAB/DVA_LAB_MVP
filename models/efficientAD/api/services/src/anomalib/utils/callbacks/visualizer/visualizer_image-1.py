...
from anomalib.post_processing.visualizer import result_box
    ...
    def on_predict_batch_end(
        ...
        for i, image in enumerate(self.visualizer.visualize_batch(outputs)):
            ...
            if self.save_images:
                ...
                '''
                self.visualizer._visualize_full()
                result = result_box
    ...
    def on_test_batch_end(
        ...
        for i, image in enumerate(self.visualizer.visualize_batch(outputs)):
            ...
            if self.save_images:
                ...
                #self.visualizer.savejson(file_path)
                #Visualizer.savejson(file_path)
                #result = Visualizer.bbox()
                #print(result)
                #self.visualizer.savejson(file_path, result)
